...
enum ApproxiamtionMethod {LEASTSQAURES, FOURIER, LAGRANGE};
...
int main() {
    ...
    cout << endl;
    cout << "Please select your approximation method by typing a number between 1 and 3" << endl;
    ...
    try {
        //Convert the given humber to enum type
        switch(choice)
        {
            case 1: usersApproxChoice = LEASTSQAURES;
                break;
