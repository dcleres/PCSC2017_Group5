...
void LeastSquare::solve(Data data,int degree,vector<vector<double>> beta)
{
    ...
    leastsquare.Solve(A,q,degree+1,beta[0]); //on resout ce système avec la méthode Solve implémenté dans AbstractNumericalApproximation
